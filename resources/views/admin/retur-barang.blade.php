...
<body>
    ...
    <div class="content" id="content">
      ...
      <div class="container mb-3">
        <!-- Tambah Data button -->
        <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#tambahBarangRModal">
        Tambah <i class="bi bi-plus-circle"></i>
        </button>

        <div class="search-bar">
          <div>
            <form action="/retur-barang"  class="input-group">
      ...
      <!-- Tambah Data -->
      <div class="modal fade" id="tambahBarangRModal" tabindex="-1" aria-labelledby="tambahBarangRModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="tambahBarangRModalLabel">Tambah Barang Masuk</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="tambahBarangRForm" method="POST" action="{{ route('admin.retur-barang.store') }}">
                        @csrf
                        <input type="hidden" name="jenis_transaksi" value="Retur Barang">
                        <div class="mb-3">
        ...
        <table class="table table-hover">
          ...
          <tbody class="table-group-divider">
            @forelse($barangrs as $index => $product)
            <tr>
              <td>{{ ($barangrs->currentPage() - 1) * $barangrs->perPage() + $index + 1 }}</td>
