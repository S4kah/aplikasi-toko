...
<body style="height: 100vh; overflow: hidden;">
    ...
    <div class="content" style="margin-left: 250px; padding: 20px; overflow-y: auto;">
      ...
      <div class="d-flex justify-content-between align-items-center mt-3">
        ...
        <a href="{{ route('admin.barang.make') }}" class="btn btn-primary bi bi-plus-circle"> Tambah</a>
     ...
     <table class="table table-hover">
          ...
          <tbody class="table-group-divider">
            ...
            <tr>
              ...
              <td>
                          <a href="{{ route('admin.barang.edit', $product->id) }}" class="btn btn-warning btn-sm"><i class="bi bi-pencil-square"></i> Edit</a>
                          <form action="{{ route('admin.barang.destroy', $product->id) }}" method="POST" class="d-inline">
                              @csrf
                              @method('DELETE')
      ...
      <div class="d-flex justify-content-between align-items-center mt-3">
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination mt-2">
                ...
                @else
                    <li class="page-item"><a class="page-link" href="{{ $barangs->previousPageUrl() }}">Previous</a></li>
                @endif
