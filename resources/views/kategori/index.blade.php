...
<body style="height: 100vh; overflow: hidden;">
    <div class="sidebar bg-dark text-white d-flex flex-column p-3"
        ...
        <div class="nav flex-column mb-auto">
            <a href="{{ route('admin.barang.index') }}" class="btn btn-outline-light text-start mb-2"><i
                    class="bi bi-box-seam-fill"></i> Barang</a>
            <a href="{{ route('admin.jenis.index') }}" class="btn btn-outline-light text-start mb-2"><i
                    class="bi bi-receipt-cutoff"></i> Jenis Barang</a>
            <a href="{{ route('admin.barang-masuk.index') }}" class="btn btn-outline-light text-start mb-2"><i
                    class="bi bi-dropbox"></i> Barang Masuk</a>
            <a href="{{ route('admin.retur-barang.index') }}" class="btn btn-outline-light text-start mb-2"><i
                    class="bi bi-box2-fill"></i> Retur Barang</a>
            <a href="{{ route('admin.user.index') }}" class="btn btn-outline-light text-start mb-2"><i
        ...
        <table class="table table-hover">
            ...
            <tbody class="table-group-divider">
                @forelse ($kategoris as $kategori)
                    <tr>
                        <th scope="row">
                            {{ ($kategoris->currentPage() - 1) * $kategoris->perPage() + $loop->iteration }}</th>
                ...
                <ul class="pagination mt-2">
                    ...
                    @else
                        <li class="page-item"><a class="page-link"
                                href="{{ $kategoris->previousPageUrl() }}">Previous</a></li>
                    @endif
